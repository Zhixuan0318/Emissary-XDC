...
const Request: React.FC<Props> = ({ emissary, connected, address, role }) => {
        ...
        try {
            if (safe.lump_check) {
                ...
                const config = await prepareSendTransaction({
                    to: safe.recipient,
                    value: parseEther(safe.lump_amount.amount)
                })
                    ...
                    </div>
                    {
                        ...
                        <div className='flex-start'>
                            ...
                            </div>
                            {
                                ...
                                <Link href={'https://apothem.blocksscan.io/tx/' + safe.lump_amount.hash} target="_blank" passHref>
                            ...
                            return (
                                <div key={idx} className='flex-start'>
                                    ...
                                    {mile.approved >= Number(safe.approver) && mile.hash &&
                                        <Link href={'https://apothem.blocksscan.io/tx/' + mile.hash}>
                                            <div className='ml-10 text-underline pink-text font-14 no-wrap'>View Transfer Memo</div>
                                        </Link>
                                    }
                                </div>
