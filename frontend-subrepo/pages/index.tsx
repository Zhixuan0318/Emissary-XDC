...
const Index: React.FC<Props> = ({ subdomain, role, connected, address, connectWallet }) => {
    ...
    const c = new MetaMaskConnector({ chains })
                        ...
                        <Container maxWidth="lg" >
                            <Grid container spacing={3}>
                                <Grid item xs={12} sm={12} md={9} className='land-text-wrap mb-70'>
                                    <span className='land-text'>A better way to receive payouts on the XDC Network. </span>
                    ...
                    <div className='land-body'>
                        <Container maxWidth="lg" >
                            <Grid container spacing={3}>
                                ...
                                <Grid item xs={12} sm={12} md={6}>
                                    <div className='lunch-item'>
                                        <p className='lunch-text font-24 mt-40'>Welcome to XDC DAO’s emissary.</p>
