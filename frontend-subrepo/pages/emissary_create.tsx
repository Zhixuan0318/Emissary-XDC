...
const Index: React.FC<Props> = ({ address, connected }) => {
    ...
    return (
        <>
            <div className='noti-bar'>
                <p>A project developed in XDC Hackathon: APAC Edition 2023</p>
            </div>
                    ...
                    <Grid container spacing={3}>
                            ...
                            <>
                                ...
                                <Grid item xs={12} sm={12} md={6}>
                                    <div className='lunch-item text-center'>
                                        ...
                                        <p className='lunch-text '>XDC Pay</p>
                                        <p className='lunch-text-sub text-underline'>Do not have XDC Pay? Download here</p>
                                        <div className='mt-30'>
                                            <Button className='white-btn w-100' onClick={() => open()}  >Connect</Button>
                                        </div>
                                    </div>
                                </Grid>
                            </>
                        }
                        {
                            ...
                            <>
                                <Grid item xs={12} sm={12} md={6}>
                                    <div className='lunch-item'>
                                        <p className='lunch-text font-24 mt-40'>Welcome to XDC's emissary.</p>
                                ...
                                <Grid item xs={12} sm={12} md={6}>
                                    <div className='lunch-item text-center'>
                                        <img className='lunch-icon-b' src='assets/img/subwallet-logo.png' />
                                        <p className='lunch-text '>XDC Pay</p>
                                        <p className='lunch-text-sub text-underline'>Don't have XDC Pay? Download here</p>
                                        <div className='mt-30'>
                                            {
